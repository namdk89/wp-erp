...
function erp_acct_get_formatted_payment_data( $data, $voucher_no, $invoice_no = 0 ) {
    ...
    $payment_data['customer_name'] = isset( $user_info ) ? $user_info->last_name . ' ' . $user_info->first_name : '';
    ...
    $payment_data['pay_to']       = isset( $user_info ) ? $user_info->last_name . ' ' . $user_info->first_name : '';
