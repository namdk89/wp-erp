...
       
    ...
    var TimilineMixin = {
        ...
        methods: {
            toggleFooter: function() {
                if ( wpTLMvue.isAdmin || wpTLMvue.isTmlManager || this.checkOwnFeeds() ) {
            ...
            checkOwnFeeds: function() {
                return ( wpTLMvue.isAgent ) && this.feed.created_by.ID == wpTLMvue.current_user_id;
            },
            ...
            isActivityPage: function() {
                return ( wpTLMvue.isActivityPage === undefined ) ? false : true;
            },

            deleteFeed: function( feed ) {
                var data = {
                    action : 'erp_tlm_delete_customer_activity',
                    feed_id : feed.id,
                    _wpnonce : wpTLMvue.nonce
                };


                if ( confirm( wpTLMvue.confirm ) ) {
    ...
    Vue.component( 'new-note-component', {
        ...
        template: '#erp-tlm-timeline-feed-new-note',
        ...
        computed: {
            ...
            createdUserName: function() {
                return ( this.feed.created_by.ID == wpTLMvue.current_user_id ) ? this.i18n.you : this.feed.created_by.display_name;
            },

            createdForUser: function() {
                return _.contains( this.feed.course.types, 'company' ) ? this.feed.course.company : this.feed.course.last_name + ' ' + this.feed.course.first_name;
            },
        }
    });
    ...
    Vue.component( 'email-component', {
        ...
        template: '#erp-tlm-timeline-feed-email',
    ...
    Vue.component( 'log-activity-component', {
        ...
        template: '#erp-tlm-timeline-feed-log-activity',
        ...
        computed: {
            ...
            invitedUser: function() {
                ...
                return this.feed.extra.invited_user.map( function( elm ) {
                    if ( elm.id == wpTLMvue.current_user_id ) {
    ...
    Vue.component( 'tasks-component', {
        ...
        template: '#erp-tlm-timeline-feed-task-note',
        ...
        computed: {
            ...
            invitedSingleUser: function() {
                if ( this.feed.extra.invited_user[0].id == wpTLMvue.current_user_id ) {
