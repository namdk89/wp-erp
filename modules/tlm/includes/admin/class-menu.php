...
class Admin_Menu {
    ...
    public function admin_menu() {
        ...
        erp_add_menu( 'tlm', [
            'title'      => __( 'Courses', 'erp' ),
            'capability' => 'erp_tlm_list_course',
            'slug'       => 'courses',
            'callback'   => [ $this, 'course_page' ],
            'position'   => 5
        ] );
        ...
        erp_add_menu( 'tlm', [
            ...
            'capability' => 'erp_tlm_manage_activites',
            'slug'       => 'activities',
        ...
        erp_add_menu( 'tlm', [
            ...
            'capability' => 'erp_tlm_manage_schedules',
            'slug'       => 'schedules',
        ...
        erp_add_menu( 'tlm', [
            'title'      => __( 'Course Groups', 'erp' ),
            'capability' => 'erp_tlm_manage_groups',
            'slug'       => 'course-groups',
            'callback'   => [ $this, 'course_group_page' ],
            'position'   => 25
        ] );
...
//        $overview = add_submenu_page( 'erp-sales', __( 'Overview', 'erp' ), __( 'Overview', 'erp' ), 'erp_tlm_manage_dashboard', 'erp-sales', [ $this, 'dashboard_page' ] );
//        add_submenu_page( 'erp-sales', __( 'Courses', 'erp' ), __( 'Courses', 'erp' ), 'erp_tlm_list_course', 'erp-sales-customers', [ $this, 'course_page' ] );
//        add_submenu_page( 'erp-sales', __( 'Companies', 'erp' ), __( 'Companies', 'erp' ), 'erp_tlm_list_course', 'erp-sales-companies', [ $this, 'company_page' ] );
//        add_submenu_page( 'erp-sales', __( 'Activities', 'erp' ), __( 'Activities', 'erp' ), 'erp_tlm_manage_activites', 'erp-sales-activities', [ $this, 'activity_page' ] );
//        $schedule = add_submenu_page( 'erp-tlm', __( 'Schedules', 'erp' ), __( 'Schedules', 'erp' ), 'erp_tlm_manage_schedules', 'erp-sales-schedules', [ $this, 'schedules_page' ] );
//        add_submenu_page( 'erp-sales', __( 'Course Groups', 'erp' ), __( 'Course Groups', 'erp' ), 'erp_tlm_manage_groups', 'erp-sales-course-groups', [ $this, 'course_group_page' ] );
//        add_submenu_page( 'erp-sales', __( 'Reports', 'erp' ), __( 'Reports', 'erp' ), 'erp_tlm_manage_dashboard', 'erp-sales-reports', array( $this, 'page_reports' ) );
//
//        //Help page
//        add_submenu_page( 'erp-sales', __( 'Help', 'erp' ), __( '<span style="color:#f18500">Help</span>', 'erp' ), 'erp_tlm_manage_dashboard', 'erp-tlm-help', array( $this, 'help_page' ) );
//
//        add_action( 'admin_print_styles-' . $overview, array( $this, 'tlm_calendar_script' ) );
//        add_action( 'admin_print_styles-' . $schedule, array( $this, 'tlm_calendar_script' ) );
     ...
     * @return void
     */
    public function tlm_calendar_script() {
    ...
    public function dashboard_page() {
        include WPERP_TLM_VIEWS . '/dashboard.php';
        $this->tlm_calendar_script();
    }
    ...
    public function course_page() {
        ...
        switch ( $action ) {
            ...
            case 'view':
                $customer = new Course( $id );

                if ( ! $customer->id ) {
                    wp_die( esc_html__( 'Course not found!', 'erp' ) );
                }

                $template = WPERP_TLM_VIEWS . '/course/single.php';
                break;

            default:
                $template = WPERP_TLM_VIEWS . '/course.php';
                break;
        }

        $template = apply_filters( 'erp_course_template', $template, $action, $id );
    ...
    public function company_page() {
        ...
        switch ( $action ) {
            ...
            case 'view':
                ...
                $template = WPERP_TLM_VIEWS . '/company/single.php';
                break;

            default:
                $template = WPERP_TLM_VIEWS . '/company.php';
                break;
        }
    ...
    public function leads_page() {
        ...
        switch ($action) {
            ...
            case 'view':
                $template = WPERP_TLM_VIEWS . '/leads/single.php';
                break;

            default:
                $template = WPERP_TLM_VIEWS . '/leads.php';
                break;
        }
    ...
    public function schedules_page() {
        include WPERP_TLM_VIEWS . '/schedules.php';
        $this->tlm_calendar_script();
    }
    ...
    public function activity_page() {
        include WPERP_TLM_VIEWS . '/activities.php';
    }
     ...
     * @return void
     */
    public function course_group_page() {
        ...
        switch ($action) {
            ...
            case 'view-subscriber':
                $template = WPERP_TLM_VIEWS . '/course-group/subscribe-course.php';
                break;

            default:
                $template = WPERP_TLM_VIEWS . '/course-groups.php';
                break;
        }

        $template = apply_filters( 'erp_course_group_template', $template, $action, $id );
    ...
    public function single_page_app() {
        include WPERP_TLM_VIEWS . '/single-page-table.php';
    }
    ...
    public function campaigns_page() {
        ...
        switch ($action) {
            ...
            default:
                $template = WPERP_TLM_VIEWS . '/campaigns.php';
                break;
        }
    ...
    public function page_reports() {
        ...
        switch ( $type ) {
            case 'customer-report':
                $template = WPERP_TLM_VIEWS . '/reports/customer-report.php';
                break;

                case 'activity-report':
                $template = WPERP_TLM_VIEWS . '/reports/activity-report.php';
                break;

            case 'growth-report':
                $template = WPERP_TLM_VIEWS . '/reports/growth-report.php';
                break;

            default:
                $template = WPERP_TLM_VIEWS . '/reports.php';
                break;
        }

        $template = apply_filters( 'erp_tlm_reporting_pages', $template, $type );
    ...
    public function help_page(){
        include WPERP_TLM_VIEWS . '/help.php';
    }
}
