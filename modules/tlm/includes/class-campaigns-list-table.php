...
class Campaign_List_Table extends \WP_List_Table {
    ...
    function get_columns() {
        ...
        return apply_filters( 'erp_tlm_campaign_table_cols', $columns );
    }
    ...
    function column_name( $campaign ) {
        ...
        $actions['edit']     = sprintf( '<a href="%s" data-id="%d" title="%s">%s</a>', $delete_url, $campaign->id, __( 'Edit this Course Group', 'erp' ), __( 'Edit', 'erp' ) );
        $actions['delete']   = sprintf( '<a href="%s" class="submitdelete" data-id="%d" title="%s">%s</a>', $delete_url, $campaign->id, __( 'Delete this Course Group', 'erp' ), __( 'Delete', 'erp' ) );
    ...
    function prepare_items() {
        ...
        $this->items  = erp_tlm_get_campaigns( $args );

        // Render total customer according to above filter
        $args['count'] = true;
        $total_items = erp_tlm_get_campaigns( $args );
