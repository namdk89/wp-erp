...
class Course_Taxonomy {
    ...
    public function __construct( $taxonomy = '', $slug = '', $args = array(), $labels = array() ) {
        ...
        // JIT
        do_action( 'erp_tlm_taxonomy', $this );
    }
    ...
    protected function parse_options() {
        return wp_parse_args( $this->args, array(
            ...
            'capabilities' => array(
                'manage_terms' => 'erp_tlm_edit_course',
                'edit_terms'   => 'erp_tlm_edit_course',
                'delete_terms' => 'erp_tlm_edit_course',
                'assign_terms' => 'erp_tlm_edit_course',
            ),
