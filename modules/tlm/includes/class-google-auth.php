...
//        $access_token = $this->client->getAccessToken();
    ...
    public function has_credentials() {
        $options = get_option( 'erp_settings_erp-tlm_email_connect_gmail', [] );
    ...
    public function get_settings_url() {
        $settings_url = add_query_arg( [ 'page' => 'erp-settings', 'tab' => 'erp-tlm', 'section' => 'email_connect', 'sub_section' => 'gmail' ], admin_url( 'admin.php' ) );
        return $settings_url;
    }
