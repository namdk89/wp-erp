...
?>
<div class="wrap erp erp-tlm-customer erp-single-customer" id="wp-erp">

    <h2><?php esc_attr_e( 'Company #', 'erp' ); echo esc_attr( $customer->id ); ?>
        <a href="<?php echo esc_url_raw( add_query_arg( ['page' => 'erp-tlm', 'section' => 'companies' ], admin_url( 'admin.php' ) ) ); ?>" id="erp-course-list" class="add-new-h2"><?php esc_attr_e( 'Back to Company list', 'erp' ); ?></a>

        <?php if ( current_user_can( 'erp_tlm_edit_course', $customer->id ) || current_user_can( erp_tlm_get_manager_role() ) ): ?>
            <span class="edit">
                <a href="#" @click.prevent="editCourse( 'company', '<?php echo esc_attr( $customer->id ); ?>', '<?php esc_attr_e( 'Edit this company', 'erp' ); ?>' )" data-id="<?php echo esc_attr( $customer->id ); ?>" data-single_view="1" title="<?php esc_attr_e( 'Edit this Company', 'erp' ); ?>" class="add-new-h2"><?php esc_attr_e( 'Edit this Company', 'erp' ); ?></a>
            </span>
            <?php if ( ! $customer->user_id && erp_tlm_current_user_can_make_wp_user() ): ?>
                <span class="make-wp-user">
                    <a href="#" @click.prevent="makeWPUser( 'company', '<?php echo esc_attr( $customer->id ); ?>', '<?php esc_attr_e( 'Make WP User', 'erp' ); ?>', '<?php echo esc_attr( $customer->email ) ?>' )" data-single_view="1" title="<?php esc_attr_e( 'Make this course as a WP User', 'erp' ); ?>" class="add-new-h2"><?php esc_attr_e( 'Make WP User', 'erp' ); ?></a>
                </span>
            <?php endif ?>
        <?php endif ?>
    </h2>
            ...
            <div class="col-2 column-left erp-single-customer-row">
                ...
                <div class="left-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4 details">
                                ...
                                <ul class="erp-list list-inline social-profile">
                                    ...
                                    <?php do_action( 'erp_tlm_company_social_fields', $customer ); ?>
                                </ul>
                    ...
                    <div class="postbox customer-basic-info">
                        ...
                        <div class="inside">
                            <ul class="erp-list separated">
                                ...
                                <?php do_action( 'erp_tlm_single_company_basic_info', $customer ); ?>
                            </ul>
                                        ...
                                        <div class="user-wrap-content">
                                            ...
                                            <?php if ( $tlm_user_id && ! empty( $user ) ): ?>
                                                ...
                                                <div class="user-details">
                                                    <a href="#"><?php echo esc_html( get_the_author_meta( 'display_name', $tlm_user_id ) ); ?></a>
                                                    <span><?php echo esc_html( get_the_author_meta( 'user_email', $tlm_user_id ) ); ?></span>
                                                </div>
                                            <?php else: ?>
                                                <div class="user-details">
                            ...
                            <div class="tagsdiv" id="tagsdiv-erp-tlm-tag">
                                <div class="nojs-tags hide-if-js">
                                    ...
                                    <p><textarea name="tax_input[erp_tlm_tag]" rows="3" cols="20" class="the-tags" id="tax-input-erp_tlm_tag" aria-describedby="new-tag-post_tag-desc">
                                            <?php echo esc_html( implode(',', $course_tags)); ?>
                                        </textarea></p>
                                </div>
                                ...
                                <div class="jaxtag">
                                    <div class="ajaxtag hide-if-no-js">
                                        ...
                                        <p>
                                            ...
                                            <input type="button" id="add-tlm-tag" class="button tagadd" value="<?php esc_attr_e('Add'); ?>" /></p>
                                    </div>
                    ...
                    <course-company-relation
                        ...
                        type="company_courses"
                        add-button-txt="<?php esc_attr_e( 'Assign a course', 'erp' ) ?>"
                        title="<?php esc_attr_e( 'Courses', 'erp' ); ?>"
                    ></course-company-relation>
                    ...
                    <?php do_action( 'erp_tlm_company_left_widgets', $customer ); ?>

                </div>
            </div>

            <div class="col-4 column-right">
                <?php include WPERP_TLM_VIEWS . '/company/feeds.php'; ?>
            </div>
