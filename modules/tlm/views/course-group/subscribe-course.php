<div class="wrap erp-tlm-subscriber-course" id="wp-erp">
    ...
    <h2><?php esc_attr_e( 'Subscribed Courses', 'erp' ); ?>
        ...
        <a href="<?php echo esc_url_raw( add_query_arg( [ 'page' => 'erp-tlm', 'section' => 'course-groups' ], admin_url( 'admin.php' ) ) ) ?>" class="add-new-h2" title="<?php esc_attr_e( 'Back to Course Group', 'erp' ); ?>"><?php esc_attr_e( 'Back to Course Group', 'erp' ); ?></a>
    </h2>
