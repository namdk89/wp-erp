...
<div class="erp-customer-feeds" id="erp-customer-feeds" v-cloak>
    ...
    <div class="activity-form">
        ...
        <div class="nav-content" id="erp-tlm-feed-nav-content">
            <form action="" method="post" @submit.prevent="addCustomerFeed()" id="erp-tlm-activity-feed-form" enctype="multipart/form-data">
                ...
                <?php do_action( 'erp_tlm_feeds_nav_content' ); ?>
