<link rel="stylesheet" href="<?php echo esc_url_raw(WPERP_TLM_ASSETS . '/css/erp-subscription-edit.css?ver=' . WPERP_VERSION ); ?>">
...
<?php if ( ! empty( $course_lists ) ): ?>
    <form class="<?php echo esc_html( implode( ' ', $class_names ) ); ?>">
        ...
        <ul>
            <?php foreach ( $course_lists as $list_type => $lists ): ?>
