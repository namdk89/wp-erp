...
$block = !erp_tlm_sync_is_active() ? 'tlm-blocked' : '';
$settings_url = add_query_arg( [ 'page' => 'erp-settings', 'tab' => 'erp-tlm', 'section' => 'email_connect' ], admin_url( 'admin.php' ) );
?>
<div id="email" class="<?php echo esc_html( $block ); ?>">

    <?php if( !erp_tlm_sync_is_active() ) : ?>
    ...
    <p class="email-templates">
        <select name="select_templates" id="erp-tlm-activity-insert-templates" v-model="emailTemplates" v-selecttwo="emailTemplates" class="select2" v-on:change="insertSaveReplies()" style="width: 100%" data-placeholder="Select a templates...">
