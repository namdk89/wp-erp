...
<div id="log-activity">
    ...
    <p v-if="feedData.log_type == 'meeting'">
        <select name="selected_course" id="erp-tlm-activity-invite-course" v-model="feedData.inviteCourse" v-selecttwo="feedData.inviteCourse" class="select2" multiple="multiple" style="width: 100%" data-placeholder="<?php esc_attr_e( 'Agents or managers..', 'erp' ) ?>">
