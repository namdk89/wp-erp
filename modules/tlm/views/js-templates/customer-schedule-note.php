...
$notification_types = erp_tlm_activity_schedule_notification_type();
?>
...
<div id="schedule">
    ...
    <div class="clearfix"></div>
    <p>
        <select name="invite_course" id="erp-tlm-activity-invite-course" v-model="feedData.inviteCourse" v-selecttwo="feedData.inviteCourse" class="select2" multiple="multiple" style="width: 100%" data-placeholder="<?php esc_attr_e( 'Agents or managers..', 'erp' ) ?>">
