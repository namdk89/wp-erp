...
<div id="tasks">
    ...
    <div class="assign-task-wrap">
        ...
        <p class="assign-taskes-users">
            <select name="selected_course" v-model="feedData.inviteCourse" v-selecttwo="feedData.inviteCourse" class="select2" multiple="multiple" style="width: 100%" data-placeholder="<?php esc_attr_e( 'Agents or managers..', 'erp' ) ?>">
