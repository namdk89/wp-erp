<div class="erp-tlm-customer-make-wpuser" id="erp-tlm-customer-make-wpuser">
    <# if ( '' == data.email ) { #>
        <div class="row">
    ...
    <div class="row">
        ...
        <select name="customer_role" id="wp-user-role">
            <?php erp_tlm_dropdown_roles( get_option('default_role') ); ?>
        </select>
    </div>
    ...
    <?php wp_nonce_field( 'erp-tlm-make-wp-user' ); ?>
    <input type="hidden" name="action" value="erp-tlm-make-wp-user">
