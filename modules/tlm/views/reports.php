            ...
            foreach ( $left_column as $key => $report ) {
                ...
                <div class="postbox">
                    ...
                    <div class="inside">
                        ...
                        <p><a class="button button-primary" href="admin.php?page=erp-tlm&section=reports&type=<?php echo esc_attr( $key ); ?>"><?php esc_attr_e( 'View Report', 'erp' ); ?></a></p>
                    </div>
                </div><!-- .postbox -->
            <?php
                }
