<form class="<?php echo wp_kses_post( implode( ' ', $class_names ) ); ?>">
    ...
    <?php if ( ! empty( $args['full_name_lbl'] ) ): ?>
        <label class="full-name">
            ...
            <input type="text" name="course[full_name]" placeholder="<?php echo esc_html( $args['full_name_placeholder'] );?>">
        </label>
    ...
    <?php else: ?>
        <?php if ( ! empty( $args['first_name_lbl'] ) ): ?>
            <label class="first-name">
                ...
                <input type="text" name="course[first_name]" placeholder="<?php echo esc_html( $args['first_name_placeholder'] );?>">
            </label>
        <?php endif; ?>
        ...
        <?php if ( ! empty( $args['last_name_lbl'] ) ): ?>
            <label class="last-name">
                ...
                <input type="text" name="course[last_name]" placeholder="<?php echo esc_html( $args['last_name_placeholder'] );?>">
            </label>
        <?php endif; ?>
    <?php endif; ?>
    ...
    <label class="email">
        ...
        <input type="email" name="course[email]" placeholder="<?php echo esc_html( $args['email_placeholder'] );?>">
    </label>

    <?php do_action( 'erp_subscription_form_after_email', $args ); ?>

    <?php foreach ( $course_groups as $group_id ): ?>
